 ...
 * Conecta las rutas con el modelo Proyecto (Eloquent/ORM, Eval. 2)
 * y con las vistas. Todas las rutas de este controlador están
 * protegidas por el middleware auth.usuario (ver routes/web.php).
 */
...
class ProjectController extends Controller
{
    ...
    {
        $proyectos = Proyecto::with('creador')->orderByDesc('id')->get();
    ...
    public function store(Request $request)
    {
        ...
        // created_by: id del usuario autenticado (guardado en sesión por AuthController::login)
        $validado['created_by'] = $request->session()->get('usuario_id');
